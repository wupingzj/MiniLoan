...
public class LoginActivity extends Activity {
	 ...
	 */
	private static final String[] DUMMY_CREDENTIALS = new String[] { "foo@yang.com:hello", "bar@yang.com:world" };

	/**
	 * The default email to populate the email field with.
	 */
	public static final String EXTRA_EMAIL = "com.yang.android.authenticatordemo.extra.EMAIL";
